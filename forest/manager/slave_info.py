...
PARALLEL_PRODUCER_REQUEST_COUNT_KEY=config.PARALLEL_PRODUCER_REQUEST_COUNT_KEY # 最大单次请求处理数量 来自 redis
PARALLEL_PRODUCER_ITEM_COUNT_KEY=config.PARALLEL_PRODUCER_ITEM_COUNT_KEY # 最大单次 item 处理数量 来自 redis
DEFAULT_PARALLEL_PRODUCER_REQUEST_COUNT=config.DEFAULT_PARALLEL_PRODUCER_REQUEST_COUNT # 默认最大请求处数量
DEFAULT_PARALLEL_PRODUCER_ITEM_COUNT=config.DEFAULT_PARALLEL_PRODUCER_ITEM_COUNT # 默认单次 item 最大处理数量

PARALLEL_JOB_ITEM_COUNT_KEY=config.PARALLEL_JOB_ITEM_COUNT_KEY
PARALLEL_JOB_REQUEST_COUNT_KEY=config.PARALLEL_JOB_REQUEST_COUNT_KEY
